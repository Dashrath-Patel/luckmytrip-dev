...
const HomePage = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-blue-100 to-blue-10 min-h-screen">
                ...
                <div className="relative z-30 h-full flex items-center">
                  <div className="px-8 md:px-16 py-10 md:py-16 max-w-xl">
                    ...
                    <div className="mb-6 md:mb-8">
                      <img
                        src="/src/assets/vip jackpot .svg"
      ...
      {/* Spin Luck */}
      <section className="py-8 md:py-12 bg-[#E9F2FF] relative overflow-hidden">
            ...
            <div className="bg-white rounded-3xl shadow-lg p-8 md:p-12">
              <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
                ...
                <div className="flex flex-col items-start">
                  {/* SPIN LUCK Title */}
                  <div className="mb-4">
                    <h2 className="font-montserrat text-[#8AC43F]  origin-bottom scale-y-150 text-4xl md:text-6xl lg:text-7xl font-black text-green-500 leading-none tracking-tight">
                      SPIN LUCK
                    </h2>
                  </div>
